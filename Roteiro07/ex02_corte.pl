...
%    Call: (10) aprecia(vicente, d) ? Unknown option (h for help)
...
%    Call: (10) aprecia(vicente, _40814) ? creep
%    Call: (11) bigKahunaBurger(_40814) ? creep
%    Exit: (11) bigKahunaBurger(b) ? creep
%    Call: (11) fail ? creep
%    Fail: (11) fail ? creep
%    Fail: (10) aprecia(vicente, _40814) ? creep
% false.