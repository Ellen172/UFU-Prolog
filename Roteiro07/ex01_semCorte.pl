...
% [trace]  ?- max(3,5,X).
%    Call: (10) max(3, 5, _7940) ? creep
%    Call: (11) 3=<5 ? creep
%    Exit: (11) 3=<5 ? creep
%    Exit: (10) max(3, 5, 5) ? creep
% X = 5 ;
%    Redo: (10) max(3, 5, _7940) ? creep
%    Call: (11) 3>5 ? creep
%    Fail: (11) 3>5 ? creep
%    Fail: (10) max(3, 5, _7940) ? creep
% false.
...
%    Exit: (10) max(3, 5, 5) ? creep
% true ;
%    Redo: (10) max(3, 5, 5) ? creep
%    Fail: (10) max(3, 5, 5) ? creep
% false.
...
% [trace]  ?- max(5,3,X).
%    Call: (10) max(5, 3, _15712) ? creep
%    Call: (11) 5=<3 ? creep
%    Fail: (11) 5=<3 ? creep
%    Redo: (10) max(5, 3, _15712) ? creep
%    Call: (11) 5>3 ? creep
%    Exit: (11) 5>3 ? creep
%    Exit: (10) max(5, 3, 5) ? creep
% X = 5.